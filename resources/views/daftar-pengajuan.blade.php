...
<head>
    ...
    <title>ISBN YPIK PAM JAYA - Daftar Naskah</title>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; font-family:'Inter',sans-serif; }
        ...
        .status-badge { display:inline-flex; align-items:center; gap:5px; padding:5px 12px; border-radius:20px; font-size:.75rem; font-weight:600; }
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="page-header">
            <div class="page-title-section">
                <h1>Daftar Naskah</h1>
                <p class="page-subtitle">Pantau status dan riwayat pengajuan naskah Anda.</p>
            </div>
            <a href="/pengajuan" class="btn-primary">
                <i class="fa-solid fa-plus"></i> Ajukan Naskah
            </a>
        </div>
