            ...
            <div class="card">
                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            @if(!isset($laporanNaskah) || $laporanNaskah->isEmpty())
                                <tr>
                            ...
                            @else
                                @foreach($laporanNaskah as $item)
                                <tr>
                                    <td>
                                        <div class="ms-title">{{ $item->judul }}</div>
                                        <div class="ms-id">ID: MS-{{ $item->id }}</div>
                                    </td>
                                    <td>
                                        @if($item->status == 'Draf')
                                    ...
                                    <td>
                                        <div class="date-text">{{ $item->created_at ? $item->created_at->format('d M Y') : '-' }}</div>
                                    </td>
                                    <td style="text-align:center">
                                        <a href="/pengajuan/{{ $item->id }}" class="action-btn" title="Lihat detail">
