    ...
    <main class="main-content" id="mainContent">
            ...
            <div class="header-actions">
                <div class="user-wrapper">
                    ...
                    <div class="user-dropdown" id="userDropdown">
                        <a href="/admin/profile" class="user-dropdown-item active"><i class="fa-regular fa-user"></i><span>Profil Saya</span></a>
        ...
        <div class="profile-grid">
            ...
            <div class="settings-container">
                ...
                <!-- Personal Info -->
                <form action="{{ route('admin.profile.update') }}" method="POST" style="height: 100%;">
                    @csrf
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input type="email" class="form-control" value="{{ $admin->email ?? '' }}" disabled style="opacity: 0.6;">
                                </div>
                            </div>
                            <div class="form-group">
